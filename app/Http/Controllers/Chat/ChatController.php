...
{
    public function conversations(MessageService $messageService, ProfessionalService $professionalService) {
        $user = request()->user();
        $professional = $professionalService->getProfessionalInfo((int) $user->id);
        $chats = $messageService->getChatsForUser((int) $user->id, $professional?->id);
    ...
    public function direct(int $professionalId, Request $request, MessageService $messageService, ProfessionalService $professionalService)
    {
        $user = $request->user();
        $targetProfessional = $professionalService->getProfessionalById($professionalId);
        ...
        $chat = $messageService->getChatByParticipants((int) $user->id, (int) $targetProfessional->id);
        $created = false;
    ...
    public function index(int $chatId, MessageService $messageService, ProfessionalService $professionalService) {
        ...
        $messages = $messageService->getAllChatMessages($chatId);
